    ...
    public partial class equipos : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                grupos.mostrar_grupos(droplist_seleccion);
        ...
        protected void droplist_seleccion_SelectedIndexChanged(object sender, EventArgs e)
        {
            mostrar_seleccion();
        }
        ...
        {
            string grupo = (droplist_seleccion.Items.Count == 0) ? null : droplist_seleccion.SelectedValue;
            if (grupo != null)
            {
                grid_seleccion.DataSource = Grupo.vista_equipo_grupo(grupo);
                grid_seleccion.DataBind();
            }
        }
    }
}