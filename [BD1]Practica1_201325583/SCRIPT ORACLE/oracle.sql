...
create table EVENTO (
	...
	hora date not null,
	D_cod_disciplina integer not null,
	TP_cod_participacion integer not null,
	CATEGORIA_cod_categoria integer not null,
	constraint PK_evento primary key (cod_evento),
	constraint FK_evento_cod_disciplina foreign key (D_cod_disciplina) references DISCIPLINA (cod_disciplina),
	constraint FK_evento_cod_participacion foreign key (TP_cod_participacion) references TIPO_PARTICIPACION (cod_participacion),
...
check (fecha_hora between TO_DATE('2020-07-24 09:00:00', 'YYYY-MM-DD HH:MI:SS') and TO_DATE('2020-08-09 20:00:00', 'YYYY-MM-DD HH24:MI:SS'));
...
alter table EVENTO modify ( ubicacion integer );
...
alter table MIEMBRO modify ( telefono default 0 not null );
...
insert into EVENTO (cod_evento, fecha_hora, ubicacion, D_cod_disciplina, TP_cod_participacion, CATEGORIA_cod_categoria)
values (1, TO_DATE('2020-07-24 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), 3, 2, 2, 1);
insert into EVENTO (cod_evento, fecha_hora, ubicacion, D_cod_disciplina, TP_cod_participacion, CATEGORIA_cod_categoria)
values (2, TO_DATE('2020-07-26 10:30:00', 'YYYY-MM-DD HH24:MI:SS'), 1, 6, 1, 3);
insert into EVENTO (cod_evento, fecha_hora, ubicacion, D_cod_disciplina, TP_cod_participacion, CATEGORIA_cod_categoria)
values (3, TO_DATE('2020-07-30 18:45:00', 'YYYY-MM-DD HH24:MI:SS'), 5, 7, 1, 2);
insert into EVENTO (cod_evento, fecha_hora, ubicacion, D_cod_disciplina, TP_cod_participacion, CATEGORIA_cod_categoria)
values (4, TO_DATE('2020-08-01 12:15:00', 'YYYY-MM-DD HH24:MI:SS'), 2, 1, 1, 1);
insert into EVENTO (cod_evento, fecha_hora, ubicacion, D_cod_disciplina, TP_cod_participacion, CATEGORIA_cod_categoria)
values (5, TO_DATE('2020-08-08 19:35:00', 'YYYY-MM-DD HH24:MI:SS'), 4, 10, 3, 1);
...
alter table COSTO_EVENTO MODIFY ( tarifa numeric(10, 2) );
...
delete from (
    select E.* from EVENTO E INNER JOIN DISCIPLINA D
    on E.d_cod_disciplina = D.cod_disciplina
);

delete from (
    select DA.* from DISCIPLINA_ATLETA DA INNER JOIN DISCIPLINA D
